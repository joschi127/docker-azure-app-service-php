...
# docker build -t "$1"/azure-app-service-php:5.6.21-apache_"$buildnumber" 5.6.21-apache
# docker build -t "$1"/azure-app-service-php:5.6.21-apache-xdebug_"$buildnumber" 5.6.21-apache-xdebug
# docker build -t "$1"/azure-app-service-php:7.0.6-apache_"$buildnumber" 7.0.6-apache
# docker build -t "$1"/azure-app-service-php:7.0.6-apache-xdebug_"$buildnumber" 7.0.6-apache-xdebug
# docker build -t "$1"/azure-app-service-php:7.2.1-apache-xdebug_"$buildnumber" -t "$1"/azure-app-service-php:latest-xdebug_"$buildnumber" 7.2.1-apache-xdebug
docker build -t "$1"/azure-app-service-php:7.2.1-apache_"$buildnumber" -t "$1"/azure-app-service-php:latest_"$buildnumber" 7.2.1-apache
